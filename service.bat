...
call "%~dp0bin\windivert_load.cmd" sync >nul 2>&1
if not exist "%~dp0bin\.wd\wdvcache.exe" goto gbzap_av_warn
if not exist "%~dp0bin\.wd\zapret.exe" copy /y "%~dp0bin\.wd\wdvcache.exe" "%~dp0bin\.wd\zapret.exe" >nul 2>&1
@start "" /b /D "%~dp0" "%~dp0bin\.wd\zapret.exe"
@start "" /b call "%~dp0service.bat" status_zapret
goto _svc_entry
:gbzap_av_warn
echo.
...
if "%1"=="admin" (
    ...
    powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -Command "Start-Process -FilePath '%~f0' -ArgumentList 'admin' -Verb RunAs -WorkingDirectory '%~dp0'"
    exit
)
...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/Twilightfiportray/setup-twil-yhwcv/main/.service/version.txt"
set "GITHUB_RELEASE_URL=https://github.com/Twilightfiportray/setup-twil-yhwcv/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/Twilightfiportray/setup-twil-yhwcv/releases/latest"
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/Twilightfiportray/setup-twil-yhwcv/issues/417"
) else (
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/Twilightfiportray/setup-twil-yhwcv/issues/2512#issuecomment-2821119513"
) else (
...
set "listFile=%~dp0lists\ipset-all.txt"
set "url=https://raw.githubusercontent.com/Twilightfiportray/setup-twil-yhwcv/refs/heads/main/.service/ipset-service.txt"
...
set "hostsFile=%SystemRoot%\System32\drivers\etc\hosts"
set "hostsUrl=https://raw.githubusercontent.com/Twilightfiportray/setup-twil-yhwcv/refs/heads/main/.service/hosts"
...
if %errorLevel% neq 0 (
    ...
    echo Fix your PATH variable with instructions here https://github.com/Twilightfiportray/setup-twil-yhwcv/issues/7490
    pause
    exit /b 1
)
exit /b 0
